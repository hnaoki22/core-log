 ...
 * 道場2 課題図書：ブルシット・ジョブ研究レポート / イシューからはじめよ / 仮説思考
 * 道場3 以降：未定のため CORE ユニバーサルを利用
 */
...
const EXAMPLES: ExampleSet[] = [
  ...
  // ─────────────────────────────────────────
  // 道場2 武装
  // 課題図書：ブルシット・ジョブ研究レポート / イシューからはじめよ / 仮説思考
  // テーマ：業務5S / Phoenix問題構造化 / イシュー度×解の質 / 仮説検証 / 影響の輪
  // ─────────────────────────────────────────
  {
    phase: 2,
    type: "morning",
    examples: [
      {
        text: "例：今日のToDoリストを眺めて、「無くなっても誰も困らない仕事」が紛れていないか点検してから動く",
        source: "BSジョブ研究 4分類診断 × C",
      },
      {
        text: "例：今日取り組む課題の中で、解の質を上げることよりも「問い自体を疑うこと」に時間を使ってみる",
        source: "イシューからはじめよ イシュー度 × R",
      },
      {
        text: "例：会議で発言する前に「自分の仮説はこうだ」と先に声に出してから議論に入ってみる",
        source: "仮説思考 仮説先行 × E",
      },
      {
        text: "例：今日やる仕事を1つ選んで「これはStop/Slim/Standard/System/Shiftのどれか」と仕分けてみる",
        source: "業務5S × C",
      },
      {
        text: "例：「当たり前」だと思っている業務手順について、「ゼロから設計するなら同じやり方にするか」と問うてみる",
        source: "Phoenix問題構造化 × R",
      },
      {
        text: "例：着手する前に「この作業はイシュー度が高いか」と自分に問う。低ければ別のことに時間を振り向ける",
        source: "イシューからはじめよ 犬の道 × R",
      },
      {
        text: "例：「変えられない」と思い込んでいることを1つ選び、自分の影響の輪に引き込めないか試してみる",
        source: "影響の輪 × O",
      },
    ],
  },
  {
    ...
    examples: [
      {
        text: "例：今日やった仕事のうち、「無くなっても誰も困らないもの」はなかっただろうか",
        source: "BSジョブ研究 4分類 × R",
      },
      {
        text: "例：今日、「犬の道」を歩いていた時間はどれくらいあっただろうか。イシュー度の低い作業に埋もれなかったか",
        source: "イシューからはじめよ 犬の道 × R",
      },
      {
        text: "例：データを集める前に仮説を立てただろうか。それとも情報の海に時間を使ってしまっただろうか",
        source: "仮説思考 仮説先行 × E",
      },
      {
        text: "例：今日「忙しかった」としたら、その忙しさのうちStop/Slimできるものは何割あっただろうか",
        source: "業務5S × C",
      },
      {
        text: "例：今日取り組んだ問題は、本当に自分が考え抜くべき問題だったか。5Sで片付く問題ではなかったか",
        source: "Phoenix × シートA/B順序設計 × R",
      },
      {
        text: "例：「これは自分の仕事じゃない」と思った瞬間に、影響の輪の外に押し出していなかっただろうか",
        source: "影響の輪 × O",
      },
      {
        text: "例：「もう少し調べてから」と判断を先送りした場面はなかったか。60点の仮説で先に動けただろうか",
        source: "仮説思考 × E",
      },
    ],
  },
